...
const SIMULATOR_MODE =
  process.env.SIMULATOR_MODE || 'development';

if (SIMULATOR_MODE !== 'development') {
  console.error(
    'Simulator blocked: Production Firestore writes are disabled.'
  );
...
if (
  ...
  console.error(
    'Refusing to write simulator data to production Firebase project.'
  );
